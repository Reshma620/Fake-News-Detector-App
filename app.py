...
if st.button("Predict"):
    ...
    if news.strip() != "":
        ...
        # ❌ REMOVED WRONG DEBUG TYPE LINE (THIS WAS CAUSING CONFUSION)
        # st.write("Type:", type(prediction[0]))

        st.subheader("📢 Prediction Result")

        # ✅ FIXED ONLY LOGIC (NO STRUCTURE CHANGE)
        pred = prediction[0]

        if pred == 1 or str(pred).lower() == "real":
